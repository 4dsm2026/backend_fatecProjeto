    ...
    issues: {
      ...
      items: {
        ...
        properties: {
          ...
          message: {
            type: "string",
            example: "Mínimo de 8 caracteres",
          },
          code: {
            type: "string",
            example: "too_small",
...
export default async function authRoutes(app: FastifyInstance) {
  ...
  // exatamente como já era antes desta alteração.
    ...
    "/primeiro-acesso",
    {
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            token: {
              ...
              example:
                "3f1c9e2a7b8d4f0a91c6e5b2d8a7f4c1e0b9a8d7c6f5e4b3a2c1d0e9f8b7a6c5",
            },
            ...
            newPassword: {
              ...
              // Replica em uma única regra as exigências do Zod:
              // mínimo de 8 caracteres, 1 minúscula, 1 maiúscula,
        ...
        response: {
          ...
          409: {
            description:
              "O `personalEmail` informado já está em uso por outra conta.",
          ...
          500: {
            description:
              "Erro inesperado ao concluir o primeiro acesso.",
